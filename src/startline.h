#define STARTLINE_PEBBLE_VERSION "StartLine Pebble V3.3 bld 10"
#define STARTLINE_PEBBLE_TIME_VERSION "StartLine Pebble Time v3.3 bld 10"

#define CONFIG_SUPPORT
...
#define KEY_LAY_TIME     19
  ...
  // Configuration keys
    #define KEY_CONFIG_BOLD 131
    #define KEY_CONFIG_RACEBOX 132
    #define KEY_CONFIG_VIBEDISCONNECT 133
    #define KEY_CONFIG_COLOURAWA 134
...
extern bool useBold;
extern bool racebox;
extern bool vibeDisconnect;
extern int screenMessageTimer;
#ifdef PBL_COLOR
extern bool colourAWA;
#endif
#endif
...
extern const keyTitle keyTitles[];
